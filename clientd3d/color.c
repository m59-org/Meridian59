...
// {"248,208,96"},    /* COLOR_STATSGFGD */
   ...
   {"166,166,166"},   /* COLOR_ITEM_NAME_BGREEN, green*/
   {"0,255,0"},       /* COLOR_ITEM_NAME_CYAN, cyan */
   {"0,225,255"},     /* COLOR_ITEM_NAME_YELLOW, yellow */
   {"255,238,0"},     /* COLOR_ITEM_NAME_ORANGE, orange */
   {"255,80,0"},      /* COLOR_ITEM_NAME_PURPLE, purple */
   {"187,0,255"},     /* COLOR_ITEM_NAME_RED, red */
   {"255,0,0"},       /* COLOR_ITEM_NAME_DGREEN, dark green */
   {"80,140,20"}      /* COLOR_ITEM_NAME_GREY, grey */
};
